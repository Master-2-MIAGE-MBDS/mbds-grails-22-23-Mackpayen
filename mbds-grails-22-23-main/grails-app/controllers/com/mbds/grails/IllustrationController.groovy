...
class IllustrationController {
    ...
    /*def uploadImage(Illustration illustration, HttpServletRequest request){
        if (request.getFile("illustrationImage") && !request.getFile("illustrationImage").filename.equals("")){
            String image = FileUtil.uploadContactImage(illustration.id, request.getFile("illustrationImage"))
            if (!image.equals("")){
